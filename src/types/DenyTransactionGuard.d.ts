...
interface DenyTransactionGuardInterface extends ethers.utils.Interface {
  functions: {
...
export class DenyTransactionGuard extends BaseContract {
  ...
  interface: DenyTransactionGuardInterface;
