...
interface IApplicationReviewRegistryInterface extends ethers.utils.Interface {
  functions: {
...
export class IApplicationReviewRegistry extends BaseContract {
  ...
  interface: IApplicationReviewRegistryInterface;
